...
main_path = 'D:/PycharmProjects/IndeedSourceCODE'
os.chdir(main_path)

city_list = ['Philadelphia', 'San+Francisco', 'New+York', 'California', 'Houston', 'Boston', 'Chicago', 'Seattle',
             'Austin', 'Maryland']
...
for city_index in range(0, len(city_list)):
    ...
    for page_index in range(1, 9):
        ...
        for i in range(0, len(job_summary_list)):
            # i = 2
...
results_path = 'D:/PycharmProjects/indeed/city_wise_results'
